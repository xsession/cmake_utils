...
if __name__ == '__main__':
    ...
    data2 = find_all_files('reactive_frameworks\c_rf')
    # print(data2)

    data3 = find_neighbors('reactive_frameworks\c_rf')
    print(data3)

    # with open('./project_resources.json', 'w') as ps:
    #     json.dumps(data, ps, indent=2)

    # with open('./project_resources.json', 'r') as ps:
    #     data2 = json.load(ps)
    #     print(data2)
